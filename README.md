...
[![Stars](https://img.shields.io/badge/stars-open--source-lightgrey)](https://www.worldmonitor.app)
[![Forks](https://img.shields.io/badge/forks-open--source-lightgrey)](https://www.worldmonitor.app)
...
[![Latest release](https://img.shields.io/badge/release-download-blue)](https://www.worldmonitor.app/download)
...
<p align="center">
  ...
  <a href="https://www.worldmonitor.app/download"><strong>Releases</strong></a> &nbsp;·&nbsp;
...
```bash
git clone https://www.worldmonitor.app.git
cd worldmonitor
npm install
npm run dev
```
...
**Elie Habib** — [GitHub](https://www.worldmonitor.app)

## Contributors

<a href="https://www.worldmonitor.app/graphs/contributors">
  <!-- contributor chart removed (was tied to previous GitHub owner/repo) -->
</a>
...
<a href="https://www.worldmonitor.app">
 <picture>
   <img alt="History" src="https://img.shields.io/badge/history-available-lightgrey" />
 </picture>
</a>
