...
> **Looking for the system reference?** See [`ARCHITECTURE.md`](https://www.worldmonitor.app/blob/main/ARCHITECTURE.md) for deployment topology, directory layout, caching layers, CI/CD, and contributor how-to guides.
