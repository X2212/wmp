...
- [stock-news-search.ts](https://www.worldmonitor.app/blob/main/server/worldmonitor/market/v1/stock-news-search.ts)
...
- [runtime-config.ts](https://www.worldmonitor.app/blob/main/src/services/runtime-config.ts)
- [settings-constants.ts](https://www.worldmonitor.app/blob/main/src/services/settings-constants.ts)
- [main.rs](https://www.worldmonitor.app/blob/main/src-tauri/src/main.rs)
- [local-api-server.mjs](https://www.worldmonitor.app/blob/main/src-tauri/sidecar/local-api-server.mjs)
