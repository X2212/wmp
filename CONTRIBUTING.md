...
Use the [Bug Report issue template](https://www.worldmonitor.app/issues/new/choose) when available.
...
Use the [Feature Request issue template](https://www.worldmonitor.app/issues/new/choose) when available.
