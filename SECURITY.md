...
1. **GitHub Private Vulnerability Reporting**: Use [GitHub's private vulnerability reporting](https://www.worldmonitor.app/security/advisories/new) to submit your report directly through the repository.

2. **Direct Contact**: Alternatively, reach out via the contact details on [worldmonitor.app](https://www.worldmonitor.app).
