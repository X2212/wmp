...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  full: {
    title: 'CommoHedge Monitor - Real-Time Global Intelligence Dashboard',
    ...
    siteName: 'CommoHedge Monitor',
    shortName: 'CommoHedge Monitor',
  ...
  happy: {
    title: 'CommoHedge Monitor - Good News',
  ...
  finance: {
    title: 'CommoHedge Monitor - Finance',
  ...
  commodity: {
    title: 'CommoHedge Monitor - Commodities',
